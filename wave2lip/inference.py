...
import torch
from wave2lip import audio
from wave2lip import face_detection
from wave2lip.models import Wav2Lip
...
if __name__ == '__main__':
    ...
    parser.add_argument('--audio', type=str,
                        ...
                        default='D:/Side/SieProject/Wave2Lip/voice_Sample.wav', required=False)
    ...
    #     command = 'ffmpeg -y -i {} -strict -2 {}'.format(args.audio, 'D:/Side/SieProject/Wave2Lip/temp/temp.wav')
    #
    #     subprocess.call(command, shell=True)
    #     args.audio = 'D:/Side/SieProject/Wave2Lip/temp/temp.wav'
    #
    ...
    os.system(
        f'ffmpeg -i {args.audio} -i temp/result.avi -c copy D:/Side/SieProject/Wave2Lip/temp/temp.avi'
    )
